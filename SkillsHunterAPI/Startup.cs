...
namespace SkillsHunterAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<ProjectContext>(o => o.UseSqlServer(connectionString: "Data Source=127.0.0.1;Initial Catalog=SkillsHunterDB;User ID=sa;Password=@SkillsHunter4"));
