...
export class ProjectItemComponent implements OnInit {
  ...
  constructor(private dialog:MatDialog,private projectData:projectService,private projectCrud: ProjectCRUDService) { }
  ...
  delete(project)
  {
    if(confirm(`Are you sure to delete ${project.Name}`))
    {
      ...
      this.projectCrud.createProject(project)//change so it calls update
      .subscribe(
        data=>{
