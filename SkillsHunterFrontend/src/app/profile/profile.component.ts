...
export class ProfileComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.personalDetailsForm.controls['name'].setValue(
      localStorage.getItem('name')
    );
    this.personalDetailsForm.controls['surname'].setValue(
      localStorage.getItem('surname')
    );
    this.personalDetailsForm.controls['email'].setValue(
      localStorage.getItem('email')
    );
    this.personalDetailsForm.controls['phone'].setValue(
      localStorage.getItem('phone')
    );
    this.personalDetailsForm.controls['open'].setValue(
      localStorage.getItem('openForWork')
    );
  ...
  onSubmit() {
    ...
    this.profileService.userDetailUpdate(obj).subscribe((data) => {
